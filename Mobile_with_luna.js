...
const proxyConfig = {
    proxyHost: '634a2a9018ca9169.iuy.us.ip2world.vip',
    proxyPort: '6001',
    proxyUsername: 'mmtools-zone-resi-region-us-session-7bccb3e0bdb7-sessTime-5',
    proxyPassword: 'mmtools',
    proxyProtocol: 'http'
  };
    ...
    try {
        ...
        if (proxyDetails.proxyUsername && proxyDetails.proxyPassword) {
            await page.authenticate({
                username: "dass1223-zone-resi-region-us-session-7a6528085eb8-sessTime-15",
                password: "Dassdass",
            });
        }
